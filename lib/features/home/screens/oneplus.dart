...
class onePlusMobile extends StatefulWidget {
  const onePlusMobile({super.key});
  static const String routeName = '/oneplusScreen';

  @override
  State<onePlusMobile> createState() => _onePlusMobileState();
}

class _onePlusMobileState extends State<onePlusMobile> {
